...
export const ChatComposer = memo(function ChatComposer({
  ...
  const composerPlaceholder = !isInputEditable
    ? translateUiText(disabledPlaceholder ?? "Connect to the Codex Relay server first")
    : translateUiText(isPlanMode ? PLAN_COMPOSER_PLACEHOLDER : DEFAULT_COMPOSER_PLACEHOLDER);
      ...
      >
        <View style={styles.goalEditSheet}>
          <AppBottomSheetTextInput
            ...
            placeholder={translateUiText("Goal objective")}
  ...
  return (
    ...
    >
      ...
      <TextInput
        ...
        placeholder={translateUiText("Give Codex more context")}
        placeholderTextColor={textSecondaryColor}
        multiline
