...
import { localizeNode, translateUiText } from "@/lib/i18n";
...
function Text({
  ...
  const localizedAccessibilityLabel =
    typeof accessibilityLabel === "string" ? translateUiText(accessibilityLabel) : accessibilityLabel;
  return (
    <Component
      {...props}
